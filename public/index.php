...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="bg-white p-8 rounded-lg shadow-md w-3/5">
        ...
        <?php if ($result): ?>
            ...
            <a href="<?php echo htmlspecialchars($result['downloadLink']); ?>" class="bg-blue-500 hover:bg-blue-700 text-center text-white font-bold py-2 px-4 rounded inline-block mb-4">
                Stiahnuť Excel
            </a>
        <?php else: ?>
